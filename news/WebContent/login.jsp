...
<div id="header">
  <div id="top_login">
    <form action="UserServlet?action=login" method="post" onsubmit="return check()">
      <label> 登录名 </label>
      <input type="text" name="username" value=""  id="uname" class="login_input" />
      <label> 密&#160;&#160;码 </label>
      <input type="password" name="pwd" value="" id="upwd"  class="login_input" />
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <ul class="classlist">
        ...
        <li><p align="right"> 当前页数:[1/2]&nbsp; <a href="#">下一页</a> <a href="#">末页</a> </p></li>
      </ul>
    </div>
